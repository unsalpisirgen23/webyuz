...
Route::get('/',             [App\Http\Controllers\Admin\CategoryController::class,'index'   ])->name('index')->middleware("user_roles:Categories,List");
...
Route::post('/store',       [App\Http\Controllers\Admin\CategoryController::class,'store'   ])->name('store')->middleware("user_roles:Categories,Create");
