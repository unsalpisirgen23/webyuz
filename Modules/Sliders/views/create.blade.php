...
@section("content")
    <div id="app">
        <section class="section">
            {!! import("admin.components.breadcrumb",['content'=>'Slider Ekle']) !!}
            <div class="section-body">
                <form action="{{route("modules.sliders.store")}}" method="post">
                @csrf
                <!-- Main Content -->
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="card-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <textarea class="summernote form-control " style="width: 100%;min-height: 300px;"  name="description" id=""></textarea>
                                        </div>
                                    </div>
