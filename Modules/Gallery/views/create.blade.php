...
@section("content")
    <div id="app">
        <section class="section">
            {!! import("admin.components.breadcrumb",['content'=>'Galeriye Resim Ekle']) !!}
            <div class="section-body">
                <form action="{{route("modules.gallery.store")}}" method="post">
                @csrf
                <!-- Main Content -->
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <div class="form-group row mb-4">
                                        <div class="form-group col-6 ml-auto mr-auto mb-4">
                                            ...
                                            <select class="form-control" name="gallery_categori_id">
                                                @php \App\Helpers\Category::get_gallery_options(); @endphp
