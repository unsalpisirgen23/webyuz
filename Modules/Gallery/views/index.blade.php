                        ...
                        @foreach($galleries  as $gallery)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form id="page-form-{{$gallery->id}}" action="{{ route('modules.gallery.destroy',$gallery->id) }}" method="POST" style="display: none;">
                                        {{ csrf_field() }}
                                    </form>
                                </td>
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a class="btn btn-primary btn-action w-100"  href="{{route('modules.gallery.edit',$gallery->id)}}" title="Düzenle"><i class="fas fa-pencil-alt"></i></a>
                </div>
            </div>
        </div>
    </div>
