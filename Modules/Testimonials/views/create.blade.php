...
@section("content")
    <div id="app">
        <section class="section">
            {!! import("admin.components.breadcrumb",['content'=>'Müşteri Yorumu Ekle']) !!}
            <div class="section-body">
                <form action="{{route("modules.testimonials.store")}}" method="post">
                @csrf
                <!-- Main Content -->
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="card-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Müşteri Adı</label>
                                    ...
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Sektör</label>
                                        <div class="col-sm-12 col-md-7">
...
@section("script")
    ...
    <script>
        ...
        document.getElementById('image_img').src ="/upload/sliders/upload-image.png";
        document.getElementById('image_label').value = "/upload/sliders/upload-image.png";
        ...
        document.addEventListener("DOMContentLoaded", function() {
            document.getElementById('button-image').addEventListener('click', (event) => {
                ...
                window.open('/file-manager/fm-button/?leftDisk=public&leftPath=customers', 'socialPopupWindow', `width=${wi},height=${hi},position=absolute,left=${wi/2},top=${hi/2}`);
            });
        });
