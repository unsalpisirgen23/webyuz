...
@section("content")
    <div id="app">
        <section class="section">
            {!! import("admin.components.breadcrumb",['content'=>'Yorum Güncelle']) !!}
            <div class="section-body">
                <form action="{{route("modules.testimonials.update",$testimonial->id)}}" method="post">
                @csrf
                <!-- Main Content -->
                    <div class="row">
                        <div class="col-12">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" class="form-control" name="name" value="{{$testimonial->name != null ? $testimonial->name : null}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <textarea class="summernote" name="description" id="description">{{$testimonial->description != null ? $testimonial->description : null}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                          <small>Bu alan temanız destekliyorsa çalışacaktır.</small>
                                            <input type="text" class="form-control" name="sector" value="{{$testimonial->sector != null ? $testimonial->sector : null}}">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <div class="form-group col-6 ml-auto mr-auto mb-4">
                                            ...
                                            <select class="form-control" name="status">
                                                <option value="1" {{$testimonial->status==1 ? "selected" : null }} >Aktif</option>
                                                <option value="0" {{$testimonial->status==0 ? "selected" : null }} >Pasif</option>
                                            </select>
                                        </div>
                                    </div>
...
@section("script")
    ...
    <script>
        ...
        document.getElementById('image_img').src ="{{$testimonial->img_url}}";
        document.getElementById('image_label').value = "{{$testimonial->img_url}}";
        ...
        document.addEventListener("DOMContentLoaded", function() {
            document.getElementById('button-image').addEventListener('click', (event) => {
                ...
                window.open('/file-manager/fm-button/?leftDisk=public&leftPath=costumers', 'socialPopupWindow', `width=${wi},height=${hi},position=absolute,left=${wi/2},top=${hi/2}`);
            });
        });
