                            ...
                            <div class="table-responsive">
                                <table class="table table-striped mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-action mr-1"  href="{{route('modules.scrollingPictures.edit',$scrollingPictures->id)}}" onclick="confirm('Bu düzenlemek istediğinize eminmisiniz?') ? null :event.preventDefault() " title="Düzenle"><i class="fas fa-pencil-alt"></i></a>
                                            ...
                                            <form id="slider-form-{{$scrollingPictures->id}}" action="{{ route('modules.scrollingPictures.destroy',$scrollingPictures->id) }}" method="POST" style="display: none;">
                                                {{ csrf_field() }}
                                            </form>
                                        </td>
                                    </tr>
