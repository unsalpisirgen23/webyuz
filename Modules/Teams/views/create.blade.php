...
@endsection
@section("content")
    @component("teams::components.card-form",['title'=>"Ekip Üyesi Ekle","route"=>"store"])
        <div class="row">
        ...
        <div class="form-group row mb-4">
            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Sosyal</label>
            <div class="col-sm-12 col-md-7 h-100">
                <div class="form-group-prepend">
                    <div class="form-group-text">Facebook linki</div>
                </div>
                <input type="text" class="form-control" name="facebook"  placeholder="https://facebook.com/webyuz">

                    <div class="form-group-prepend">
                        <div class="form-group-text">Instagram linki</div>
                    </div>
                    <input type="text" class="form-control" name="instagram"  placeholder="https://instagram.com/webyuz">


                    <div class="form-group-prepend">
                        <div class="form-group-text">Twitter linki</div>
                    </div>
                    <input type="text" class="form-control" name="twitter" placeholder="https://twitter.com/webyuz">
                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            document.getElementById('button-image').addEventListener('click', (event) => {
                ...
                window.open('/file-manager/fm-button/?leftDisk=public&leftPath=teams', 'socialPopupWindow', `width=${wi},height=${hi},position=absolute,left=${wi/2},top=${hi/2}`);
            });
        });
        // set file link
