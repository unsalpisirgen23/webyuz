...
@section("content")
    <div class="col-lg-12 col-md-12 col-12 col-sm-12">
        <div class="card">
            {!! import("admin.components.breadcrumb",['content'=>'Hizmetler']) !!}
                    ...
                    <table class="table table-striped mb-0" id="myTable">
                        ...
                        @foreach($services  as $service)
                            <tr style="border-bottom: solid 1px #ddd;">
                                ...
                                <td>
                                    <a class="btn btn-primary btn-action mt-3"  href="{{services_route("edit",$service->id)}}" onclick="confirm('Bu düzenlemek istediğinize eminmisiniz?') ? null :event.preventDefault() " title="Düzenle"><i class="fas fa-pencil-alt"></i></a>
                                    ...
                                    <form id="page-form-{{$service->id}}" action="{{ services_route("destroy",$service->id)}}" method="POST" style="display: none;">
                                        {{ csrf_field() }}
                                    </form>
                                </td>
