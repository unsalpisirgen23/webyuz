                    ...
                    <table class="table table-striped mb-0" id="myTable">
                        ...
                        @foreach($sliders  as $slider)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary btn-action mr-1"  href="{{route('admin.sliders.edit',$slider->id)}}" onclick="confirm('Bu düzenlemek istediğinize eminmisiniz?') ? null :event.preventDefault() " title="Düzenle"><i class="fas fa-pencil-alt"></i></a>
                                    ...
                                    <form id="page-form-{{@$slider->id}}" action="{{ route('admin.sliders.destroy',@$slider->id) }}" method="POST" style="display: none;">
                                        {{ csrf_field() }}
                                    </form>
                                </td>
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a class="btn btn-primary btn-action w-100"  href="{{route('admin.sliders.edit',$slider->id)}}" title="Düzenle"><i class="fas fa-pencil-alt"></i></a>
                </div>
            </div>
        </div>
    </div>
