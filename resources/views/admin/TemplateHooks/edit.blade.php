...
@section("content")
    <div id="app">
        <section class="section">
            {!! import("admin.components.breadcrumb",['content'=>'Tema Yerleşimleri Güncelle']) !!}
            <div class="section-body">
                <form action="{{route("admin.TemplateHooks.update",$id)}}" method="post">
                @csrf
                <!-- Main Content -->
                    <div class="row">
                        <div class="col-12">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="form-group row mb-4">
                                          ...
                                          <div class="col-sm-12 col-md-7">
                                              <input type="text" class="form-control" value="{{$template_hook->action_title}}" name="action_title">
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group row mb-4">
                                          ...
                                          <div class="col-sm-12 col-md-7 h-100">
                                              <select name="action_group" id="action_group" class="form-control">
                                                  <option value="headers" {{$template_hook->action_group == "headers" ? "selected" : null}} >Üst Kısımlar</option>
                                                  <option value="contents" {{$template_hook->action_group == "headers" ? "selected" : null}} >Orta Kısımlar</option>
                                                  <option value="footers" {{$template_hook->action_group == "headers" ? "selected" : null}} >Alt Kısımlar</option>
                                              </select>
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group row mb-4">
                                          ...
                                          <div class="col-sm-12 col-md-7 h-100">
                                              <select name="component_widget_id" id="template_id" class="form-control">
                                                  @php get_template($template_hook->template_id); @endphp
                                              </select>
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group row mb-4">
                                          ...
                                          <div class="col-sm-12 col-md-7 h-100">
                                              <select name="action_status" id="action_status" class="form-control">
                                                  <option value="1" {{$template_hook->action_status == 1 ? "selected" : null}} >Aktif</option>
                                                  <option value="0" {{$template_hook->action_status == 0 ? "selected" : null}} >Pasif</option>
                                              </select>
                                          </div>
                                      </div>
