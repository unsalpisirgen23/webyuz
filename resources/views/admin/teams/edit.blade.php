...
@section("content")
    <div id="app">
        <section class="section">
            {!! import("admin.components.breadcrumb",['content'=>'Ekip Güncelle']) !!}
            <div class="section-body">
                <form action="{{teams_route("update",$service->id)}}" method="post">
                @csrf
                <!-- Main Content -->
                    <div class="row">
                        <div class="col-12">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="form-group row mb-4">
                                          ...
                                          <div class="col-sm-12 col-md-7 h-100">
                                              ...
                                              <input type="text" class="form-control" name="facebook" value="{{$service->facebook}}" placeholder="https://facebook.com/webyuz">

                                              <div class="form-group-prepend">
                                                  <div class="form-group-text">Instagram linki</div>
                                              </div>
                                              <input type="text" class="form-control" name="instagram" value="{{$service->instagram}}"  placeholder="https://instagram.com/webyuz">


                                              <div class="form-group-prepend">
                                                  <div class="form-group-text">Twitter linki</div>
                                              </div>
                                              <input type="text" class="form-control" name="twitter" value="{{$service->twitter}}" placeholder="https://twitter.com/webyuz">
                                          </div>
